        ...
        return [
            ...
            'slug' => [
                ...
                function ($attribute, $value, $fail) use ($pageId) {
                    ...
                    if ($pageService->slugExistsInScope($value, $parentId, $pageId)) {
            ...
            'parent_id' => [
                ...
                function ($attribute, $value, $fail) use ($pageId) {
                    ...
                    // Prevent circular reference (cannot set descendant as parent)
                    if ($value) {
                        $pageService = app(PageService::class);
                        if ($pageService->wouldCreateCycle($pageId, $value)) {
                            $fail('Cannot set a descendant page as parent (circular reference).');
                        }
                    }
                },
            ],
