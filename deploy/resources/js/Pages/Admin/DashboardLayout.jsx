...
export default function DashboardLayoutEditor({ role = 'admin', availableWidgets = [], layout = [] }) {
    const d = useD();
    ...
    return (
        <DashboardLayout title="Dashboard Layout">
            ...
            <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
                <div className="flex items-center gap-2">
                    ...
                    <select
                        ...
                        onChange={(e) =>
                            router.get(
                                route('admin.dashboard.layout.edit'),
                                { role: e.target.value },
                ...
                <div className="flex items-center gap-2">
                    <Link href={role === 'seller' ? route('seller.dashboard') : route('admin.dashboard')} className="btn-secondary">
                        View Dashboard
                    </Link>
                    <button
                        type="button"
                        ...
                        onClick={() => {
                            form.put(route('admin.dashboard.layout.update'), {
                                preserveScroll: true,
                            });
                        }}
                    >
