...
const DEFAULT_NAV = [
    ...
    },
    {
        ...
        children: [
            { label: 'Hybrid Flooring', url: '/shop?category=clearance-hybrid-flooring' },
            { label: 'Subway Tiles', url: '/shop?category=clearance-subway-tiles' },
            { label: 'Indoor Tiles', url: '/shop?category=clearance-indoor-tiles' },
            { label: 'Outdoor Tiles', url: '/shop?category=clearance-outdoor-tiles' },
            { label: 'Engineered Flooring', url: '/shop?category=clearance-engineered-flooring' },
        ],
    },
    {
        label: 'Tiles',
        ...
        children: [
            ...
            { label: '20mm & 10mm External Tiles', url: '/shop?category=external-porcelain' },
            { label: 'Decorative Tiles', url: '/shop?category=decorative-tiles' },
            { label: 'Mosaic', url: '/shop?category=mosaic' },
            { label: 'Tiles', url: '/shop?category=tiles' },
        ],
    },
    {
        label: 'Trade',
