...
Route::prefix('coupons')->name('coupons.')->group(function () {
    ...
    Route::put('{coupon}', [\App\Domain\Marketing\Http\Controllers\Admin\CouponController::class, 'update'])->name('update');
    Route::delete('{coupon}', [\App\Domain\Marketing\Http\Controllers\Admin\CouponController::class, 'destroy'])->name('destroy');
    Route::post('{coupon}/toggle-status', [\App\Domain\Marketing\Http\Controllers\Admin\CouponController::class, 'toggleStatus'])->name('toggle-status');
